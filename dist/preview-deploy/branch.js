...
exports.checkBranchEligibility = checkBranchEligibility;
exports.determineWorkerName = determineWorkerName;
/**
 * Check if the current branch is eligible for deployment
 */
function checkBranchEligibility(context, branchPatterns, excludeBranches) {
    // Get current branch
 ...
 */
function determineWorkerName(context, prefix, suffixStrategy, customName) {
    let suffix;
