...
- We use Oxlint for code linting
...
- Tests are located in appropriate test files
...
│   └── index.js          # Deploy action implementation
├── comment/               # Comment action
│   ├── action.yml        # Action definition
│   └── comment.js        # Comment action implementation
...
- Listed in future changelogs for their contributions
